...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  const panelContent = (
    <>
      {open && (
        <div
          className="sm-backdrop fixed inset-0 bg-black/40 backdrop-blur-sm transition-opacity duration-300"
          onClick={closeMenu}
          aria-hidden="true"
  ...
  // If embedded mode without logo in fixed mode, portal overlay to document.body for unconstrained sliding
  if (isFixed && !showLogo) {
    return (
      <>
        {toggleButton}
  ...
  // Standalone mode or inline mode with header
  return (
    <div
      className={
        (className ? className + " " : "") +
        ...
        {showLogo ? (
          <div className="sm-logo" aria-label="Logo">
            {logo ? (
              ...
              <img
                src={logoUrl || "/assets/owel-head.webp"}
                alt="Logo"
